...
func (service *CommonToysService) AddToy(ctx context.Context, toyData models.AddToyDTO) (uint64, error) {
...
func (service *CommonToysService) GetAllToys(ctx context.Context) ([]models.Toy, error) {
...
func (service *CommonToysService) GetMasterToys(ctx context.Context, masterID uint64) ([]models.Toy, error) {
...
func (service *CommonToysService) GetToyByID(ctx context.Context, id uint64) (*models.Toy, error) {
...
func (service *CommonToysService) GetAllMasters(ctx context.Context) ([]models.Master, error) {
...
func (service *CommonToysService) GetMasterByID(ctx context.Context, id uint64) (*models.Master, error) {
...
func (service *CommonToysService) GetAllCategories(ctx context.Context) ([]models.Category, error) {
...
func (service *CommonToysService) GetCategoryByID(ctx context.Context, id uint32) (*models.Category, error) {
...
func (service *CommonToysService) GetAllTags(ctx context.Context) ([]models.Tag, error) {
...
func (service *CommonToysService) GetTagByID(ctx context.Context, id uint32) (*models.Tag, error) {
