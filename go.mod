...
require (
	...
	github.com/DKhorkov/hmtm-notifications v1.3.1
	github.com/DKhorkov/hmtm-sso v1.6.0
	github.com/DKhorkov/hmtm-tickets v1.3.0
	github.com/DKhorkov/hmtm-toys v1.6.0
	github.com/DKhorkov/libs v1.11.1
