...
func (m *MockUseCases) CountMasters(ctx context.Context, filters *entities.MastersFilters) (uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCasesMockRecorder) CountMasters(ctx, filters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountMasters", reflect.TypeOf((*MockUseCases)(nil).CountMasters), ctx, filters)
}
...
func (m *MockUseCases) CountMyTickets(ctx context.Context, accessToken string, filters *entities.TicketsFilters) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountMyTickets", ctx, accessToken, filters)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountMyTickets indicates an expected call of CountMyTickets.
func (mr *MockUseCasesMockRecorder) CountMyTickets(ctx, accessToken, filters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountMyTickets", reflect.TypeOf((*MockUseCases)(nil).CountMyTickets), ctx, accessToken, filters)
}
...
func (m *MockUseCases) GetMasters(ctx context.Context, pagination *entities.Pagination, filters *entities.MastersFilters) ([]entities.Master, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCasesMockRecorder) GetMasters(ctx, pagination, filters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMasters", reflect.TypeOf((*MockUseCases)(nil).GetMasters), ctx, pagination, filters)
}
...
func (m *MockUseCases) GetMyTickets(ctx context.Context, accessToken string, pagination *entities.Pagination, filters *entities.TicketsFilters) ([]entities.Ticket, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMyTickets", ctx, accessToken, pagination, filters)
...
func (mr *MockUseCasesMockRecorder) GetMyTickets(ctx, accessToken, pagination, filters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMyTickets", reflect.TypeOf((*MockUseCases)(nil).GetMyTickets), ctx, accessToken, pagination, filters)
}

// GetMyToys mocks base method.
func (m *MockUseCases) GetMyToys(ctx context.Context, accessToken string, pagination *entities.Pagination, filters *entities.ToysFilters) ([]entities.Toy, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMyToys", ctx, accessToken, pagination, filters)
	ret0, _ := ret[0].([]entities.Toy)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUseCasesMockRecorder) GetMyToys(ctx, accessToken, pagination, filters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMyToys", reflect.TypeOf((*MockUseCases)(nil).GetMyToys), ctx, accessToken, pagination, filters)
}
