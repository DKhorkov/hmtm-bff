...
//
//	mockgen -source=clients.go -destination=../../mocks/clients/tickets_client.go -package=mockclients -exclude_interfaces=ToysClient,SsoClient,NotificationsClient,S3Client
//
...
func (m *MockTicketsClient) DeleteTicket(ctx context.Context, in *tickets.DeleteTicketIn, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (mr *MockTicketsClientMockRecorder) DeleteTicket(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteTicket", reflect.TypeOf((*MockTicketsClient)(nil).DeleteTicket), varargs...)
}
...
func (m *MockTicketsClient) UpdateTicket(ctx context.Context, in *tickets.UpdateTicketIn, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (mr *MockTicketsClientMockRecorder) UpdateTicket(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTicket", reflect.TypeOf((*MockTicketsClient)(nil).UpdateTicket), varargs...)
}
