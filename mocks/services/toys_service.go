...
func (m *MockToysService) GetUserToys(ctx context.Context, userID uint64, pagination *entities.Pagination) ([]entities.Toy, error) {
	m.ctrl.T.Helper()
...
func (mr *MockToysServiceMockRecorder) GetUserToys(ctx, userID, pagination any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserToys", reflect.TypeOf((*MockToysService)(nil).GetUserToys), ctx, userID, pagination)
}
